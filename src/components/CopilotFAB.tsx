...
export default function CopilotFAB() {
  ...
  const handleSend = (e: React.FormEvent) => {
    ...
    if (projectId) {
      navigate(`/chat/${projectId}`, { state: { initialMessage: message } });
    } else {
            ...
            <div className="p-4 border-b border-white/5 bg-gradient-to-r from-indigo-500/10 to-violet-500/10 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-white/50 uppercase tracking-widest font-bold">Enabled</div>
                </div>
              </div>
              <button
            ...
            <div className="p-4">
              <p className="text-xs text-white/60 mb-4 leading-relaxed">
                {projectId
                  ...
                  : "Open a project first to chat with AI about your requirements."
                }
              </p>
              ...
              {projectId ? (
                ...
                <button
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm text-white/60 hover:bg-white/10 transition-colors"
                >
                  Go to Dashboard
                </button>
              )}
